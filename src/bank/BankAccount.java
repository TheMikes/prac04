...
public class BankAccount {
     ...
     */
    // In the withdraw method first check if there are sufficient funds to be withdrawn (the account is not allowed to overdraft).
    // If there are insufficient funds then throw a FundsException with the message: String.format("Withdraw failed.
    // This account has %d in funds but %d were requested.", this.funds, amount).
